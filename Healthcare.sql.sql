...
-- Find Prescriptions Associated with Appointments Pending Payment
...
-- Identify the Most Frequently Prescribed Medications and Total Dosage
SELECT medication,
       COUNT(*) AS frequency,
...
-- Analyze Correlation Between Appointment Frequency and Billing Status
SELECT p.patient_id, p.first_name, p.last_name,
...
SELECT p.medication, p.dosage, p.instructions,
